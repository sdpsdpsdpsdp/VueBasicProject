...
export default {
  ...
  methods: {
    ...
    myMenuSelect(value) {
      ...
      console.log('emit dynamicRouterShow')
      this.$emit('dynamicRouterShow', value.key, this.activeMenu.title)
      // update-begin-author:sunjianlei date:20191223 for: 修复刷新后菜单Tab名字显示异常
      let storeKey = 'route:title:' + this.activeMenu.title
      this.$ls.set(storeKey, this.activeMenu.title)
