<template>
  <div class='components-input-demo-presuffix'>
    <!--$t('order.pleaseSelectDept')   $t('order.selectDept')-->
    <a-input @click='openModal' :placeholder='placeTitle' v-model='departNames' readOnly :disabled='disabled'>
      <a-icon slot='prefix' type='cluster' :title="$t('order.deptControl')" />
      <a-icon v-if='departIds' slot='suffix' type='close-circle' @click='handleEmpty' :title="$t('order.clear')" />
    </a-input>
